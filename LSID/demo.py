...
def main():
    ...
    parser.add_argument('--log_file', type=str, default='./log/dataset/test.log', help='log file')
    ...
    parser.add_argument('--trans_onnx', type=str, default='None')
    ...
    #transfer the model to onnx
    onnx_session = None
    if not 'None' in args.trans_onnx:
        print('Converting to ONNX format...')
        # model.eval()
        #convert to ONNX format
        model_name = 'Sony_resume_test.onnx'
        dummy_x = torch.randn(1,4,1424,2128)
        ...
        print('checked')
        onnx_session = onnxruntime.InferenceSession(model_name)
